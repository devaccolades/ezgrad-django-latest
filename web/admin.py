...
from web.models import Contact,Details,Experts,Subbanner,MainBanner,StudentTestimonials,Checklist,Blogs,Tags,Category,Careers,CareerApply,BlogComment,BlogReplyComment
